...
| T20 | Generate MVP sprite PNGs from approved prompt pack | ArtDirector | done | T19 | Done: 78 manifest-listed PNGs generated under `Assets/Generated/`; user manual review still pending |
| T21 | Create ux folder and menu/button layout specs | UXDesigner | pending | T15 | Active handoff: `Tasks/Open/21-ux-menu-folder-and-button-layout.md`; create repo-root `ux/` docs for MainMenu and in-game element placement |
